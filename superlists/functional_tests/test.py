...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_multiple_uers_can_start_lists_at_different_urls(self):
        ...
        self.assertRegex(edith_list_url, '/lists/.+')  #assertRegex verifica se uma string corresponde a uma expressão regular


        # Agora um novo usuário, Francis, chega ao site.


        ## Usamos uma nova sessão de navegador para garantir que nenhuma informação de edith está vindo de cookies etc
        self.browser.quit()
        self.browser = webdriver.Firefox()
